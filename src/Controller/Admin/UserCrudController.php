...
class UserCrudController extends AbstractCrudController
{
    ...
    public function createIndexQueryBuilder(\EasyCorp\Bundle\EasyAdminBundle\Dto\SearchDto $searchDto, EntityDto $entityDto, FieldCollection $fields, FilterCollection $filters): \Doctrine\ORM\QueryBuilder
    {
        $response = $this->userRepository->easyAdminFindAllUsers();
